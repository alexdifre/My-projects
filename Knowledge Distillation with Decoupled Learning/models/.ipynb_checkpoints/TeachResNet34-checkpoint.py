...
from CONTR_DISTILL.models.resnetv2 import ResNet34, ResNet , BasicBlock


class TeachResNet34(ResNet):  
    def __init__(self, n_cls, **kwargs):
        super().__init__(block= BasicBlock, num_blocks=[3, 4, 6, 3], num_classes = n_cls, **kwargs)
